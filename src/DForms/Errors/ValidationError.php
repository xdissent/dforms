 ...
 * Validation error
 *
 * This file defines a validation error (exception) that fields use to indicate
 * validation errors when cleaning field data.
 *
 * PHP version 5
 *
 ...
 * A validation error.
 *
 * Field validation methods should throw a validation error if the field data
 * is invalid. 
 *
 * @category   HTML
 * @package    DForms
